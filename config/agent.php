...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<strong>鸿威sass</strong>代理商后台',
    ...
    */
    ...
    'bootstrap' => app_path('Agent/bootstrap.php'),
    ...
    */
    'route' => [
        ...
        'middleware' => ['multi-session:path,/agent','web', 'admin'],
    ],
    ...
    */
    'extension_dir' => app_path('Agent/Extensions'),
